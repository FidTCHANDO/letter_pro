...
<head>
    ...
    <title>Enregistrer: Remplacement</title>
                ...
                <form action="" method="post" role="form" id="replace_form">
                    <div class="row my-2">
                        <div class="form-group col-4">
                            ...
                            <input class="form-control silver" type="text" name="reference" 
                                value = "<?php echo 'N°______/'.substr(date("Y"),-2).'/DDS-Cou/SPAF/SA' ?>" id="reference" required>
                    ...
                    <div class="row my-2">
                        <div class="form-group col-6">
                            ...
                            placeholder="Ex: Note de service N°633/24/DDS-C/SSPR/SA du 12/09/2024" required> </textarea>
                        </div>
                        <div class="form-group col-6">
                            ...
                            <!-- <input type="text" name="libele_activite" id="libele_activite" class="form-control" required> -->
                             <textarea class="form-control" name="libele_activite" id="libele_activite" required></textarea>
                            <!-- <small class="form-text text-muted">Laissez vide si correct</small> -->
                        </div>
                    ...
                    <div class="row my-2">
                        <div class="form-group col-2">
                            ...
                            <select name="budget" id="budget" class="form-select" required aria-label="Large select example">
                                    <option selected value="Budget National">Budget National</option>
                        ...
                        <div class="form-group col-4" id="divlignebn">
                            ...
                            <textarea name="lignebudgetaire" id="lignebudgetaire" placeholder="Ex: 045001000 3200121 2002000601 1 0111 6114" class="form-control"></textarea>
                        </div>
                        <div class="form-group col-4 d-none" id="other">
                            <label for="othersource"><strong>Préciser source de financement</strong></label>
                            <input type="text" name="othersource" value="" id="othersource" placeholder="Ex: OMS, UNICEF, etc." 
                            class="form-control">
                        </div>
                        <div class="form-group col-4" id="divintitule_ligne">
                            ...
                            <textarea name="intitule_ligne" value="" class="form-control" placeholder="Ex: Indemnités de mission à l'intérieur" id="intitule_ligne"></textarea>
                        </div>
                        <div class="form-group col-2" id="divgestion">
                            <label for="gestion"><strong>Année de gestion</strong></label>
                            <input type="number" class="form-control" name="gestion" id="gestion" value="<?php echo date("Y"); ?>">
                        </div>
                        <div class="form-group col-2">
                        ...
                        <div class="form-group col-2">
                            ...
                            <input type="date" name="datefin" id="datefinid" class="form-control" required>
                        </div>
