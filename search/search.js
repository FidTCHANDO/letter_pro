                ...
                for (let i = 1; i <= totalPages; i++) {
                    ...
                    if ($("#field").val() === "TITRE DE CONGÉ ADMINISTRATIF"){
                        ...
                        minitable += `<tr>
                            ...
                            <td class="">
                                <image src="../pictures/eye.svg" data-row="${acte.numero}" class="eye icon">
                                <i class="fa-solid fa-download"></i>
                                <i class="fa-solid fa-pencil icon" data-row="${acte.numero}"></i>
                                <image src="../pictures/trash.svg" data-row="${acte.numero}"
